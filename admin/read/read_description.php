<html>
    ...
    <body style = "background-color: #E0DDB3;">
        ...
        <hr>
        <h5 id = "title" ALIGN = "center"> Resultados de descripción </h1>  
        ...
        <?PHP
            ...
            //The result-column headers are printed
            echo <<< EOT
            ...
            //All the requested values are selected
            ...
            WHERE components.comDescripcion LIKE '%" . "$description" . "%';";
            $results_table = mysqli_query($connection, $query);

            //The requested values are shown in the in-construction table, 1 row per entry
